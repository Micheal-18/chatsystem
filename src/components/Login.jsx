  ...
  return (
        ...
        <div className="w-90 p-4 bg-white shadow-lg rounded-lg">
            ...
            <form className='mt-5 space-y-2'>  
                    ...
                    <input type="password" onChange={handleChangeUser} name="password" placeholder='password' className="p-2 block w-full border-gray-300 bg-[#01aa851d] rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required />
